...
<div id="enviar"></div>
	<div class="content">
		...
		<div class="home">
			...
			<p class="txtIntro">Aquí podrá hacer sus solucitudes de creación de perfiles de redes sociales, capacitaciones y asesorías</p>
	...
	<div class="content">
		...
		<div class="vertical-tabs">
			...
			<ul class="tabs vertical" data-tab="">
				<li class="tab-title tooltip <?php echo $active = isset($_POST['submitNewRedes']) ? $active = 'active' : "" ?>" title="<?php //tabNewRedesT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left"><a href="#panela1" aria-selected="true" tabindex="0">Creación de perfiles de redes sociales</a></li>
						...
						<div class="cuadricula">
							<div class="celda">
								<div class="contentCheck checkboxAudioVisual">
									<div class="colorTxt tooltip" title="<?php //checkNewRedesT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left">Seleccione la(s) red(es) social(es)</div>
									<span class="error"><?php echo $error[0][0] = (isset($error[0][0])) ? $error[0][0] : ""; ?></span><br>						
									<input type="checkbox" class="option-input checkbox" name="checkNewRedes[]" value="1" <?php if (in_array("1", $_POST['checkNewRedes'])) echo "checked"; ?> /> Facebook<br>
									<input type="checkbox" class="option-input checkbox" name="checkNewRedes[]" value="2" <?php if (in_array("2", $_POST['checkNewRedes'])) echo "checked"; ?> /> Instagram<br>
									<input type="checkbox" class="option-input checkbox" name="checkNewRedes[]" value="3" <?php if (in_array("3", $_POST['checkNewRedes'])) echo "checked"; ?> /> Twitter<br>
						...
						<div class="cuadricula">
							<div class="celda">
								<div class="group tooltip" title="<?php nombreNewPerfilT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<label>Nombre de perfil <span class="error"><?php echo $error[0][1] = (isset($error[0][1])) ? $error[0][1] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
							<div class="celda">
								<div class="group tooltip" title="<?php emailNewPerfilT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Correo o número celular para asociar a la cuenta <span class="error"><?php echo $error[0][2] = (isset($error[0][2])) ? $error[0][2] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
						...
						<div class="cuadricula">
							<div class="celda celdax3">
								<div class="group tooltip" title="<?php //numTelNewRedT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Teléfono de contacto <span class="error"><span class="error"><?php echo $error[0][5] = (isset($error[0][5])) ? $error[0][5] : ""; ?></span></label>
					  			</div>
							</div>
							<div class="celda celdax3">
								<div class="group tooltip" title="<?php //dirNewRedT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Dirección o ubicación <span class="error"><?php echo $error[0][6] = (isset($error[0][6])) ? $error[0][6] : ""; ?></label>
					  			</div>
							</div>
							<div class="celda celdax3">
							...
							<div class="celda">
								<div class="group tooltip" title="<?php //justiCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left">
									<textarea name="justiCampa" id=""><?php echo $_POST['justiCampa'] ?></textarea>
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Justificación<span class="error"><?php echo $error[1][1] = (isset($error[1][1])) ? $error[1][1] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
							<div class="celda">
								<div class="group tooltip" title="<?php //objCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left">
									<textarea name="objCampa" id=""><?php echo $_POST['objCampa'] ?></textarea>
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Objetivo <span class="error"><?php echo $error[1][2] = (isset($error[1][2])) ? $error[1][2] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
							<div class="celda">
								<div class="group tooltip" title="<?php //descripCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left">
									<textarea name="descripCampa" id=""><?php echo $_POST['descripCampa'] ?></textarea>
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Descripción <span class="error"><?php echo $error[1][3] = (isset($error[1][3])) ? $error[1][3] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
							...
							<div class="celda celdax3">
					  			<div class="group tooltip" title="<?php //fIniCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Fecha de inicio <span class="error"><?php echo $error[1][5] = (isset($error[1][5])) ? $error[1][5] : ""; ?></span></label>
					  			</div>
					  		</div>
					  		<div class="celda celdax3">
					  			<div class="group tooltip" title="<?php //fFinCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward">
					  				...
					  				<span class="bar"></span>
					  				<span class="required"></span>
					  				<label>Fecha de cierre <span class="error"><?php echo $error[1][6] = (isset($error[1][6])) ? $error[1][6] : ""; ?></span></label>
					  			</div>
					  		</div>
						</div>
						<div class="cuadricula">
							<div class="celda">
								<div class="group tooltip" title="<?php //keyCampaT(); ?>" data-tippy-arrow="true" data-tippy-animation="shift-toward" data-tippy-placement="left">
									<textarea name="keyCampa" id=""><?php echo $_POST['keyCampa'] ?></textarea>
					  				<span class="bar"></span>
					  				<label>Palabras clave o referencias de campañas similares<span class="error"><?php echo $error[1][7] = (isset($error[1][7])) ? $error[1][7] : ""; ?></span></label>
					  			</div>
							</div>
						</div>
						<div class="cuadricula">
